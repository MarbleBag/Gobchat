...
{
    public sealed class ApplicationChatComponent : IApplicationComponent, System.IDisposable
    {
        ...
        public void Initialize(ApplicationStartupHandler handler, IDIContext container)
        {
            ...
            var overlayForm = manager.GetUIElement<CefOverlayForm>(ApplicationCefOverlayComponent.OverlayUIId);
